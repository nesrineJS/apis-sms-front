...
var DashboardService = /** @class */ (function () {
    ...
    DashboardService.prototype.getSoldeDebitAmount = function (id_developer, begin_date, end_date) {
    ...
    DashboardService.prototype.getAppDev = function (id_developer, id_app, begin_date, end_date) {
        var headers = new Headers();
        headers.append('Content-Type', 'application/json');
        return this.http
