...
var ApiDocumentationComponent = /** @class */ (function (_super) {
    __extends(ApiDocumentationComponent, _super);
    /* AppTitle :any;
     AppDescription :any;
     AppUrl :any;
     AppStatus :any;
    ...
    function ApiDocumentationComponent(nav, side, notifierService, notificationService) {
