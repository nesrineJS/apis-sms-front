...
var AddAmountComponent = /** @class */ (function (_super) {
    __extends(AddAmountComponent, _super);
    function AddAmountComponent(nav, side, notifierService, notificationService) {
        var _this = _super.call(this, notifierService, notificationService) || this;
        _this.nav = nav;
        _this.side = side;
        return _this;
    }
    AddAmountComponent.prototype.ngOnInit = function () {
        this.nav.Show();
        this.side.ShowSide();
    };
    AddAmountComponent = __decorate([
        Component({
...
export { AddAmountComponent };
//# sourceMappingURL=add-amount.component.js.map